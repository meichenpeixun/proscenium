...
public interface UserMapper extends SqlMapper{
	...
	@Insert("insert web_users (username,phone,password,createTime,createIp) values (#{phone},#{phone},#{password},#{createTime},#{createIp})")
	...
	@Update("update web_users set username=#{username} where userid = #{userid}")
