...
<html>
	...
	<body onload="processerbar(3000)">
		...
		<div class="main">
			<div class="mainl fl">
				<ul>
					<li style="background:url(u/images/zuye.png) no-repeat 5px 20px;"><a href="/">主页</a><img class="fr"style="margin:23px 10px;" src="images/sj.png"></li>
					<li style="background:url(u/images/gr.png) no-repeat 5px 20px;"><a href="/">个人认证</a><img class="fr"style="margin:23px 10px;" src="images/sj.png"></li>
					...
					<li style="background:url(u/images/kecng.png) no-repeat 5px 15px;"><a href="up_kcj.htm">我的课程</a><img class="fr"style="margin:23px 10px;" src="images/sj.png"></li>
				...
				<div class="r-t-nav-box">
					...
					<div class="r-t-nav-main clearfix">
						...
						<div class="three-mun-box left">
							<ul class="clearfix">
								<li><a href="up_zsplb.htm">全部视频(80)</a></li>
								<li><a href="up_cg.htm">已通过视频(4)</a></li>
								<li><a href="up_sb.htm">未通过视频(6)</a></li>
								<li><a href="javascript:;" href="up_shz.htm">未审核视频(3)</a></li>
								<li><a class="active" href="">资料未完善(5)</a></li>
							</ul>
						</div>
