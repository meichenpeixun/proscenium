        ...
        <div class="other-right-wrap">
          <div id="pjax-container">
			<div class="us others">
			  <h1>免责申明</h1>
				<dl>
					<dd style="line-height:40px;text-indent:2em;">美享厅网站（以下简称本网站）为用户提供注册、上传视频、合作分红等服务，网站上所有的视频内容归视频上传者所有。

如视频出现内容不当，盗版，侵权等法律问题，由视频上传者本人承担， 本网站有权利对视频进行核查删除等操作，并有权对视频上传者追究法律责任。

本网站会对视频内容进行审核发布，只为上传者的视频内容进行播放和宣传服务，若视频内容涉及到法律责任均有上传者承担，本网站没有承担法律责任的义务。

本网站为互联网开放平台，会对视频进行互联网宣传，普通用户可以观看视频，可以进行分享转载操作，如涉及到版权或保密信息，请视频上传者和转载用户谨慎操作，如涉及版权问题，需视频上传者和转载者进行协商解决。

欢迎广大用户监督举报，本网站将尽最大努力保证正版视频的播放传播，保证视频所有者权益，为文化推广事业做出应有的贡献，谢谢。
</dd>
				</dl>
			</div>
          </div>
