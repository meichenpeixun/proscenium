...
<div style="" class="m-data-lists f-cb f-pr j-data-list">
 ...
 <div id="auto-id-1467597023637" class="u-cover u-find-cover">
	 <div class="wrap f-cb">
		 <a target="_blank" class="j-href wrap" href="video/play.do?id=${video.videoid}" data-index="1" data-name="和阿美一起学信息图表">
			 <div class="img"> 
				 <div class="pic f-pr"> 
					<img class="imgPic" src="${video.screenshotpath}" alt="${video.title}">
				 </div>
				 <div class="tit">
					<h3 class="f-thide">${video.title}</h3>
				 </div> 
				<!--  <div class="orgName f-fs0 f-thide"></div> --> 
				<div class="thumb">
					 <div class="f-cb" style="height:30PX;line-height:30px;"> <span class="">上传者：${video.username }</span></div>
					 <div class="">
						<span class="">播放：${video.playnumber}</span>
